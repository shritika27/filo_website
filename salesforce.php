    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Salesforce Customization & Integration Services</h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <p class=" iq-mt-20">Filo Technologies Private Limited, a specialist provider of enterprise application development and application maintenance services, embraces Salesforce implementation and customization service. Our Salesforce development & integration services help our partners to provide state of art solutions that maximize productivity which ultimately boost business and technical value. Filo Technologies Private Limited provides Salesforce configuration (with SAP, MS Dynamics, Oracle, SharePoint etc.) and the provision of deployment services.

With the Solution deployment expertise and CRM competency, Filo Technologies Private Limited is proficient at providing customized solutions using Salesforce.com, enabling higher returns on investments for customers. Our developers practice optimized Salesforce.com methodologies for implementation, support and enhancement projects to deliver high-quality solutions at finest costs. With our extensive experience in SFDC development, we enable our customers to use the Salesforce functionality in their company's existing processes and workflows to improve them and make them more efficient and effective. Filo Technologies Private Limitedcan also benefit you in customizing and personalizing existing Salesforce.com CRM solution according to customer's business needs.
</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12 iq-mt-10">
                       ...
                       <li class="iq-mt-20 iq-font-white"><i class="ion-checkmark iq-mr-10 iq-font-green"></i>“They're extremely reliable. I don't have much experience with other technology providers, but I found the process very easy. They bring good people to the table.
</li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            ...
                            <p>Salesforce integration with other Enterprise/Mobile/Open source platforms
Sales & Service Cloud Implementation
Salesforce Force.com Custom Development
Site.com Development
Salesforce Migration and Re-engineering
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div class="content-blog">
                                <p>The client is based in USA and provides Sales configuration solutions that are tightly integrated with CRM, ERP and other e-commerce systems ensuring the full automation of Quote-to-Order process. However, the normal quoting and ordering process is very time-intensive and complicated, consuming more than an hour of the sales person’s time. Thus there was a need to create a selling solution that can automate the quoting process, taking less than 10 minutes of time to prepare a quote. Filo Technologies came up with an enterprise solution which was integrated with Salesforce and simplified the quoting process. </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Corporate Intranet CRM</h6>
                            </div>
                            <div class="content-blog">
                                <p>The client is based in United Kingdom and provides financial services. They offer the corporate foreign exchange, private client transactions, and retail foreign currency services. There was a need to manage the interest in the foreign exchange services for the organization with the different lead details. Filo Technologies came up with the Salesforce solution to manage the below challenges faced before and during the implementation of the solution:

To manage the integration of the visual force form with the existing application.</p>

    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Windows Application Development Services </h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Unlock business opportunities with Windows Mobility</h2>
                            
                        </div>
                        <p class=" iq-mt-20">Recently Windows Phones are gaining steady traction among users and hardware manufacturers. Owing to a slew of updates increasingly mature functionality Windows is a chosen mobile OS for many smartphone users resulting in increased demand for Windows Mobile App Development.
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">We Offer bespoke windows App Development Services</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">UX/UI Design</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-bug iq-mb-10"></i>
                                <h6 class="iq-tw-6">
Custom Windows App Development</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-cloud iq-mb-10"></i>
                                <h6 class="iq-tw-6">App Support Maintenance and Optimization</h6>
                            </div>
                            <div class="content-blog">

            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Chatbot Development to simplify social conversation</h2>
                            
                        </div>
                        <p class=" iq-mt-20">Save money, efforts, and time to achieve perfect product development leveraging our conceptual UI/UX Design Services and Solutions. We have a long tail of happy clients because we have a habit to take our clients on a virtual tour by providing them a working prototype of their product. It helps them in understanding seen and unforeseen obstacles during project development.

The best part of our UI & UX Design and Development is without writing a single line of code, our clients are able to refine UI/UX issues, suggest changes, corrections and get them rectified to meet their needs prior to starting actual design and development work.
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Chatbot Messenger for revolutionizing your business</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">Facebook Bot Development</h6>
                            </div>
                            <div class="content-blog">
                                <p>Within few months after launching messenger, Facebook saw development and deployment of 33,000 bots in just a few months. Regardless of the size or domain, chatbot is considered as the crucial part of the company’s online marketing strategy. </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Chatbot – Alexa Skill Development</h6>
                            </div>
                            <div class="content-blog">
                                <p>With our foray into Alexa skill development, we are skilled to develop smooth, voice-activated chatbots for Echo and other Alexa aware devices. Using our expertise and skills, we will implement robust fulfillment models to develop and build sound interaction models for your Alexa skills.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">Customized Bot Development</h6>
                            </div>
                            <div class="content-blog">
                                <p>Our customized bot development services are targeted to serve enterprises looking for a more customized solution. When you are working with Sphinx, we ensure delivery of a good conversational UX for your customers without letting you blogged down in development related complexities.</p>

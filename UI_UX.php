    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">UI/UX Design Services</h2>
                        <p>The objective our UI/UX design studio is to create innovative user interface (UI) for different solutions with an aim to deliver meaningful user experience (UX).
</p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">World Class UI/UX Design Studio to
Transform Businesses into Brands</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">Research & Testing</h6>
                            </div>
                            <div class="content-blog">
                                <p>Get feedback from stakeholders, users, and investors after your receive UI/UX Designs from us with before starting the full-scale project development.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Experience Design</h6>
                            </div>
                            <div class="content-blog">
                                <p>Our UI/UX Specialist team creates a mockup and wireframe design serving as visual design drafts representing every important aspect of the project.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">Interface Design</h6>
                            </div>
                            <div class="content-blog">
                                <p>Our User Interface Designers will not leave any stone unturned to impress your potential investors and customers with a running, visually appealing and highly interactive proof of concept.</p>

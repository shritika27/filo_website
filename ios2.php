    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Other Industries</h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <p class=" iq-mt-20">Being an information technology-centric organization, Filo Technologies Private Limited grabs every opportunity to work in any technology beginning with their beta version. Such is the case with the Microsoft .NET technologies. Filo Technologies has a team of 100+ skilled software developers having hands-on experience in delivering rewarding solutions on .NET based platforms.
Filo Technologies Private Limited has dedicated teams, aligned to technology, processes, domains and necessary tools, called "Centre of Excellence". These teams help customers with any technology glitches and provide the best solution for every service we offer. Our .NET COE is one of our most experienced COEs which was established in 2002 and has delivered many successful software solutions in .NET Technology envisaging most of .NET tools and languages, .NET based architectures, servers and web services. Hence we have certified, expert and experienced ASP.net Developer to work with our customers.

Our Microsoft .Net Development team has been practising all the best practices, tools and software for .NET Technology over the years. This brings confidence to the customers for getting the most cost-effective and best quality solutions for their needs. We also provide consultancy services for the product architectures and designs.
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            ...
                            <p>Supply chain management system
...
Different e-commerce applications</p>
                        </div>
                    </div>
                </div>
                <div class="row">

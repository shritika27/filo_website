    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Block Chain Development Service </h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Blockchain App Development – Hire Blockchain Developers</h2>
                            
                        </div>
                        <p class=" iq-mt-20">Businesses started showing accelerated interest in cryptocurrency and ICO development, leading to growing demand in bitcoin and blockchain development. Here at Filo, we have earned a reputation for developing state-of-the-art mobile and web solutions and this expertise has nurtured us to present ourselves as a leading Decentralized Application Development (dApp Development) Company globally.
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Latest from blog</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">Everything You Need To Know About The Blockchain For Business</h6>
                            </div>
                            <div class="content-blog">
                                <p>Undeniably, blockchain remains an ingenious technology invention so far. Considered as a brainchild of either a person or a group of highly intelligent...</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">
How To Know If Your Business Needs Blockchain?</h6>
                            </div>
                            <div class="content-blog">
                                <p>Small and medium-sized businesses are facing so many challenges in today’s competitive business environment. Although these businesses are considered as the...</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">Next Generation Healthcare Solutions Based</h6>
                            </div>
                            <div class="content-blog">
                                <p>In healthcare, a patient’s medical records are distributed to different healthcare providers. One part is held by the primary care doctor, and several others...</p>

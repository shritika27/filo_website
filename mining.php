    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Custom Software Development Mining Industry
</h2>
                        <p>With rapidly changing back office and operations technology, Mining Companies require technologies to address more automation and integration, greater collaboration and easier access to targeted information. End customers are becoming environmentally conscious hence creating sustainable products and promoting these products and services can generate unmatched revenues.
</p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <p class=" iq-mt-20">The mining industry has become a highly profitable global business and offers exciting growth prospects due to the boom in the commodity sector. Profitability brings along various challenges. Some of the challenges faced by the mining industry are growing production demand, elevated and fluctuating commodity prices and market-driven product pricing.

The other contributing factors to these challenges are lack of quality mineral deposits, the absence of skilled workforce, diminishing margins, shortage of raw materials and escalating power, transportation and labour cost require mining companies to implement sophisticated operating models and maximize the effectiveness of their global operations.

With rapidly changing back office and operations technology, Mining Companies require technologies to address more automation and integration, greater collaboration and easier access to targeted information. End customers are becoming environmentally conscious hence creating sustainable products and promoting these products and services can generate unmatched revenues.

Filo Technologies's professional project management skills, combined with years of proven software development experience in natural resource industry helps in adding considerable business value to downstream as well as management level of mining companies. Our management level applications simplify, streamline and automate administration, sales, field work, asset and procurement processes. On the other hand, client achieves better data forecasting, accurate decision capabilities and optimum equipment utilisation with the help of downstream solutions. In this way, we build a strong foundation of knowledge, experience and people to help mining companies overcome industry challenges and turn them into opportunities in this competitive and evolving industry.
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            ...
                            <p>Managing allocation of equipment, operators, trucks and excavator
Handles massive process information and ensures data compression and security
Complete quotation management including importing quotation form external data source
Supports quotation approval workflow, the design of quotation document and configuration of system parameters
Facilitates scheduling and re-scheduling of jobs and tracking of various job activities
Timesheet management for easy tracking and comparing times devoted to different job activities</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">Asset Reporting Tool
</h6>
                            </div>
                            <div class="content-blog">
                                <p>The client maintains and operates billions of dollars of fixed and mobile assets, and the management of these assets has a profound impact on the performance of their organization where just 1% improvement can add tens or hundreds of millions of dollars to the bottom line.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Mining Survey</h6>
                            </div>
                            <div class="content-blog">
                                <p>The client wanted to automate the business process from quote generation to job inspection across their and/or their customers' mining units. </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">Equipment Monitoring System</h6>
                            </div>
                            <div class="content-blog">
                                <p>Client is one of the leading mining companies having the global presence. Three of its mining businesses are based in South Africa focusing on platinum, iron ore and Thermal Coal. In order to monitor the health status of different pieces of mining equipment, a web interface in a form of Equipment Monitoring System was a must for our client. They wanted a solution that performs analysis and interprets mining data obtained from different types of equipment; monitors working condition of the equipment pieces and minimizes the breakdowns.</p>

    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">E-commerce Development Services </h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">E-commerce Web Solutions to build,
launch, and grow your online business</h2>
                            
                        </div>
                        <p class=" iq-mt-20">We build e-commerce websites to tell a story. A story... felt and not heard, a story that drives traffic, increases leads and converts visitors into consumers.

The increased digital engagement resulted in increased consumer expectations and to fulfill these expectations, your business needs a robust digital presence. Today, buyers are expecting to find answers using digital tools of their choice, before even they reach directly to vendors, they are considered as a part of the buying cycle. Therefore, you don’t just have to be digitally present, but you need to be digitally engaged.
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">Woo Commerce</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-gears iq-mb-10"></i>
                                <h6 class="iq-tw-6">Presta Shop</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-bug iq-mb-10"></i>
                                <h6 class="iq-tw-6">NopCommerce</h6>
                            </div>
                            <div class="content-blog">

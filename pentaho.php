    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Pentaho Development</h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <p class=" iq-mt-20">Business is growing in leaps and bounds since last few decades resulting in many heterogeneous systems generating enormous data at the individual as well as organization levels. This has created a pressing need to consolidate all the data on a single common platform and conduct an in-depth analysis which would help organizations in taking the right decisions. This stream itself is named distinctly as Business Intelligence.

Pentaho BI Suite is world's most popular BI suite for reporting, analysis, dashboard, data mining, workflow and ETL (Export Transform Load) capabilities. At Filo Technologies, we are expert in Pentaho eco-system and have catered to all the stacks offering state of the art solutions to our esteemed customers.
</p>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            ...
                            <p>Enterprise Reporting
Business Analytics Using Mondrian or any MDX based OLAP
Data Migration
Big Data Integration
Embedded Pentaho (OEM)
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">
Contact Center Data Analytics</h6>
                            </div>
                            <div class="content-blog">
                                <p>Embed these offerings in a marketing strategy that will encourage people to become part of the community which in turn can drive the sales.
Enable ingesting all types of structured/semi-structured operational metrics data from all hosted/on premise ACD vendors.
Provide reliable, interactive, elegant reports to executive team/clients
Centralized role based portal system to facilitate report access, products, services, messages</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Online Electronics Application</h6>
                            </div>
                            <div class="content-blog">
                                <p>In order to get full advantage of the current business system and expand the various operations related to the marketing of their products, the client decided to develop a Java-based application that helps them to maintain technical and business benefits of the E-commerce services, latest offers, updates, etc. in effective and efficient manner..</p>

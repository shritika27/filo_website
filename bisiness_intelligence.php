    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Business Intelligence and Analytics Services</h2>
                        <p>Obtain real insights from your business data and make informed decisions by minimizing risks with our business intelligence solutions. We use popular data visualization tools such as Tableau and Qlik to derive intelligent analytical insights enabling you to solve complex business problems.
</p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Our Business Intelligence Services</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">BI Dashboard Implementation</h6>
                            </div>
                            <div class="content-blog">
                                <p>Our expert BI professionals have in-depth technical knowledge related to Business Intelligence tools and boast a proven experience in implementing all kinds of BI Solutions. Starting from data management to data warehousing and from data analytics to data visualization, our BI Implementation services span a wide spectrum. It does not matter whether you want to implement BI platform and packages for the first time or you want to merge data into different BI applications, we are there to help you.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Business Intelligence Consulting</h6>
                            </div>
                            <div class="content-blog">
                                <p>Our Business Intelligence Consulting services are instrumental in facilitating execution of precise decisions and implementing the right BI solution at the different stages of business life cycle. Ensuring to bridge the gap between desired and expected BI implementation, we thrive to reduce the risk and maximize the success of your business. If you want to strengthen your data-driven decision-making abilities, we will help you in achieving your business goals and exceeding the competition.</p>

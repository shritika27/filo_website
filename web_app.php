    ...
    <section class="overview-block-ptb iq-over-black-70 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-image: url('images/bg/03.jpg'); background-position: center center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6">Web Design & Development Services</h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Make your online presence felt with intuitive Website Design</h2>
                            
                        </div>
                        <p class=" iq-mt-20">We are a leading web design & development company in India and we are here, not only to build your online web presence but also to establish your brand. We are ‘Thinkers’ first and ‘Makers’ later. Therefore, first, we try to understand the intent, and then we understand the mood or flavor you want to represent through particular web application development. Finally, we deliver a website that is exciting, measurable, and productive.

Passion, latest trends, and innovation drives our team of professional web designer & developers. Custom software development, web application development, CMS development, Static, dynamic and blogging website development are some of areas of expertise. There are many adjectives, like reliable, appealing, classy, easy-to-use, powerful, speedy, customized, search engine friendly, premium and many more describe the repute of web designs, websites, and web applications we crafted so far.
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">Custom Software Development</h6>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Web Application Development</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">CMS Development</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-gears iq-mb-10"></i>
                                <h6 class="iq-tw-6">Static Website</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-bug iq-mb-10"></i>
                                <h6 class="iq-tw-6">Dynamic Website</h6>
                            </div>
                            <div class="content-blog">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-cloud iq-mb-10"></i>
                                <h6 class="iq-tw-6">Blogging Website</h6>
                            </div>
                            <div class="content-blog">

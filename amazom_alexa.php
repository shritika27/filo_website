            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Alexa Skills – Giving voice to your ideas</h2>
                            
                        </div>
                        <p class=" iq-mt-20">Alexa is a voice and an intelligent brain behind numerous Amazon AI devices like Echo, Echo Dot, and Echo Show. Amazon Alexa uses voice commands to find crucial reports and information for slicing and dicing the data according to the users command.
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="heading-title text-center">
                            <h2 class="title iq-tw-6">Our Alexa Skill Development Services</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            ...
                            <div><i class="fa fa-file-code-o iq-mb-10"></i>
                                <h6 class="iq-tw-6">Alexa Skills Kit (ASK)</h6>
                            </div>
                            <div class="content-blog">
                                <p>Leveraging Amazon’s pioneering knowledge in the field of voice design, we use natural user interface to make Alexa smarter and smoothen user’s interaction with device.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-mobile iq-mb-10"></i>
                                <h6 class="iq-tw-6">Alexa Voice Service (AVS)</h6>
                            </div>
                            <div class="content-blog">
                                <p>We help you to integrate Alexa in your products taking advantage of the Alexa Voice SDK to create a device software for your device so that you can get to market faster.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-mt-30">
                        <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                            <div><i class="fa fa-link iq-mb-10"></i>
                                <h6 class="iq-tw-6">The Smart Home Skill API</h6>
                            </div>
                            <div class="content-blog">
                                <p>Cloud connected devices have become a reality and we ensure flawless control of these devices by developing skills for Alexa Voice Interactions that will make your home smarter.</p>
